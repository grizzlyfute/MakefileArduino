...
#Make : compile (source in src and arduino librairie)
...
OBJ += $(SRCCPP:$(SRCDIR)/%.cpp=$(OBJDIR)/%.o)
...
#define VPATH variable to tell make to search in several directory
...
#.PHONY: This rules are not files name
